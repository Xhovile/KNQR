      ...
      <div className="flex flex-col items-center justify-center p-6 sm:p-10 bg-white border border-gray-100 rounded-2xl shadow-xl w-full" id="knqr-auth-form-container">
        ...
        <div className="grid grid-cols-2 gap-3 w-full">
          <button
            ...
            className="flex items-center justify-center gap-2 px-3 py-2.5 border border-gray-200 bg-white text-gray-400 rounded-xl text-xs font-mono uppercase shadow-xs transition-all cursor-not-allowed opacity-45"
          >
            <svg className="w-4 h-4 shrink-0 opacity-45" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-3 py-2.5 border border-gray-200 bg-white text-gray-400 rounded-xl text-xs font-mono uppercase shadow-xs transition-all cursor-not-allowed opacity-45"
          >
            <Apple className="w-4 h-4 text-black fill-black shrink-0 opacity-45" />
            Apple
          </button>
        </div>
